    ...
    <flux:sidebar sticky stashable class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
        ...
        <flux:navlist variant="outline">
            <flux:navlist.group class="grid mt-4">
                <flux:navlist.item class="bg-red-500" icon="document" :href="route('cells.select')"
                    :current="request()->routeIs('cells.select')" wire:navigate>{{ __('Criar Registro') }}
                </flux:navlist.item>
        ...
        <flux:dropdown class="hidden lg:block" position="bottom" align="start">
            ...
            <flux:menu class="w-[220px]">
                ...
                <flux:menu.radio.group>
                    <flux:menu.item :href="route('settings.profile')" icon="cog" wire:navigate>Configurações
                    </flux:menu.item>
                </flux:menu.radio.group>
